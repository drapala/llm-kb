...
- [Trade Secrets and AI — Reasonable Measures](concepts/trade-secrets-ai-hrdy-2025.md) — ⏳QUARANTINED. Hrdy 2025 Rutgers/Elgar · doutrinal map; model weights como emerging trade secret; reasonable measures requirement central
- [Enterprise Data como Trade Secrets](concepts/enterprise-data-trade-secrets-chen-2025.md) — ⏳QUARANTINED. Chen 2025 Stan. Tech. L. Rev. 29:1 · 3 categorias (confidential, private compilations, semi-public); comparative US/China/EU; Compulife critique
